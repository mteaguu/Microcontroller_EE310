...
;    
;   Registers refDx store refTemp in decimal
;   refD1 - 0x62
;   refD2 - 0x61
;   refD3 - 0x60
;    
;   registers measuredDx store measuredTemp in decimal
;   measuredD1 - 0x72
;   measuredD2 - 0x71
;   measuredD3 - 0x70
;INPUTS:
...
#define measuredTemp	15	;from sensor (in decimal)
...
refD_2:
    ...
    ;I repurposed an algorithim from the Mazidi textbook (pg 164)
    ;MOVLW   measuredTemp    ;converting measuredTemp second
    ;MOVWF   NUME	    ;load numerator
