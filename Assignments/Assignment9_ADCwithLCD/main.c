/*
 * ---------------------
 * Title: ADC and interfacing with LCD
 * ---------------------
 * Program Details:
 *  This program uses the ADC to make voltage readings and output them to an LCD
 * Inputs:
 *  Voltage Reading -> RA0
 * Outputs:
 *  RB0-RB7 -> LCD
 ...
 * Setup: C- Simulator
 * Compiler: xc8 v2.46
 * Author: Mathew Teague (Orignal Code Written by Farid Farahmand)
 * 
 * Versions:
...
void ADC_Init(void) //Function for initializing ADC
{
       //Setup ADC
